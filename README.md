...
| **`AppNotification`**          | <code>'app_notification'</code>         | Opens your app-specific notification settings screen. On iOS versions lower than 16 will have the same behavior as App. |
